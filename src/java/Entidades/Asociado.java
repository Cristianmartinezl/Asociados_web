...
public class Asociado implements Serializable {
    ...
    private List<Registradora> registradoraList;
    ...
    @XmlTransient
    public List<Registradora> getRegistradoraList() {
        return registradoraList;
    }

    public void setRegistradoraList(List<Registradora> registradoraList) {
        this.registradoraList = registradoraList;
    }
    ...
    public String toString() {
        return "Entidades.Asociado[ nombre=" + nombre + " ]";
    }
